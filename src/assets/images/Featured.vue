<template>
    <div class="frame">
        <div class="div">
            <img class="img-2" alt="Frame" src="../../public/images/f-1.svg" />
            <div class="div-2">
                <div class="text-wrapper-2">Top Brands</div>
                <div class="text-wrapper-3">With Crazy Deals!</div>
            </div>
        </div>
        <div class="div">
            <img class="img-2" alt="Frame" src="../../public/images/f-2.svg" />
            <div class="div-2">
                <div class="text-wrapper-2">Pan India Delivery</div>
                <div class="text-wrapper-3">3-5 Weekdays</div>
            </div>
        </div>
        <div class="div">
            <img class="class" alt="Frame" src="../../public/images/f-3.svg" />
            <div class="div-3">
        ...
        <div class="div">
            <img class="class" alt="Frame" src="../../public/images/f-4.svg" />
            <div class="div-2">
